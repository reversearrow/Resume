...
var bio = {
    ...
    {
        "title" : "Frameworks",
        "skillslist": "jQuery, Bootstrap, Grunt"
    },
    {
...
var work = {
    "jobs": [
    {
        ...
        "responsibilities" : ["Mentoring and assisting junior network members","Helping network team achieve highest SLA"
       	...
       	"keyachievements": ["Reduced network on-call support time required by automating Akamai Cache invalidation process using Python script","POC Network Packet Brokers and network TAPs, implemented Network Packet Broker which brought 100% visibility in the network","Implemented centralized controller to manage all DDOS mitigation appliances which led to configuration consistency and easier management for all the appliances","Automated manual route lookup process by creating a console application which saved over 80% of individuals time during that task",
